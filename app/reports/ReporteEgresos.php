<?php
    ...
    if( empty($fin) )
      $title = "REPORTE DE EGRESOS ($inicio)";
    else
      $title = "REPORTE DE EGRESOS DE ($inicio A $fin)";
   ...
   if(file_exists("ReporteDeEgresos.pdf") )
     unlink("ReporteDeEgresos.pdf");
      

   $pdf->Output("ReporteDeEgresos.pdf","F");
   echo "reports/ReporteDeEgresos.pdf";
